...
const IMaskComponent = {
  ...
  methods: {
    ...
    _onAccept() {
      ...
      this.$nextTick(() => {
        if (
          (this.maskRef.masked instanceof MaskedNumber ||
            this.maskRef.masked instanceof MaskedPattern ||
            this.maskRef.masked instanceof MaskedRegExp ||
            this.maskRef.masked instanceof MaskedDynamic) &&
          this.maskRef.cursorPos === 0 &&
          this.$props.nullOnEmpty === true
        ) {
